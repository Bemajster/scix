...
describe("Polynomial degree", () => {
  ...
  test("Polynomial degree - 2", () => {
    const p1 = new Polynomial([1, 2, 0, 5, 2])
    expect(p1.degree).toBe(4)
  })

  test("Polynomial degree - 3", () => {
    const p1 = new Polynomial([1, 2, 3, 3])
    expect(p1.degree).toBe(3)
  })

  test("Polynomial degree - 4", () => {
    const p1 = new Polynomial([])
    expect(p1.degree).toBe(0)
  })

  test("Polynomial degree - 5", () => {
    const p1 = new Polynomial([-3461, 2436, 34363])
    expect(p1.degree).toBe(2)
  })
})
